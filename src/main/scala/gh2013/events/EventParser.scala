...
object WatchEventParser extends EventParser[WatchEvent, WatchEventPayload]("WatchEvent")
{
   ...
   override def make(event: GH2011EventBody, payload: WatchEventPayload): GH2013Event = WatchEvent(event, payload)
}
...
object CreateEventParser extends EventParser[CreateEvent, CreateEventPayload]("CreateEvent")
{
   ...
   override def make(event: GH2011EventBody, payload: CreateEventPayload): GH2013Event = CreateEvent(event, payload)
}
*/
...
object ForkEventParser extends EventParser[ForkEvent, ForkEventPayload]("ForkEvent")
{
   ...
   override def make(event: GH2011EventBody, payload: ForkEventPayload): GH2013Event = ForkEvent(event, payload)
}
...
object PublicEventParser extends EventParser[PublicEvent, PublicEventPayload]("PublicEvent")
{
   ...
   override def make(event: GH2011EventBody, payload: PublicEventPayload): GH2013Event = PublicEvent(event, payload)
}
...
object PullRequestEventParser extends EventParser[PullRequestEvent, PullRequestEventPayload]("PullRequestEvent")
{
   ...
   override def make(event: GH2011EventBody, payload: PullRequestEventPayload): GH2013Event = PullRequestEvent(event, payload)
}
...
object DeleteEventParser extends EventParser[DeleteEvent, DeleteEventPayload]("DeleteEvent")
{
   ...
   override def make(event: GH2011EventBody, payload: DeleteEventPayload): GH2013Event = DeleteEvent(event, payload)
}
...
object GistEventParser extends EventParser[GistEvent, GistEventPayload]("GistEvent")
{
   ...
   override def make(event: GH2011EventBody, payload: GistEventPayload): GH2013Event = GistEvent(event, payload)
}
...
object FollowEventParser extends EventParser[FollowEvent, FollowEventPayload]("FollowEvent")
{
   ...
   override def make(event: GH2011EventBody, payload: FollowEventPayload): GH2013Event = FollowEvent(event, payload)
}
...
object GollumEventParser extends EventParser[GollumEvent, GollumEventPayload]("GollumEvent")
{
   ...
   override def make(event: GH2011EventBody, payload: GollumEventPayload): GH2013Event = GollumEvent(event, payload)
}
...
object CommitCommentEventParser extends EventParser[CommitCommentEvent, CommitCommentEventPayload]("CommitCommentEvent")
{
   ...
   override def make(event: GH2011EventBody, payload: CommitCommentEventPayload): GH2013Event = CommitCommentEvent(event, payload)
}
...
object MemberEventParser extends EventParser[MemberEvent, MemberEventPayload]("MemberEvent")
{
   ...
   override def make(event: GH2011EventBody, payload: MemberEventPayload): GH2013Event = MemberEvent(event, payload)
}
...
object DownloadEventParser extends EventParser[DownloadEvent, DownloadEventPayload]("DownloadEvent")
{
   ...
   override def make(event: GH2011EventBody, payload: DownloadEventPayload): GH2013Event = DownloadEvent(event, payload)
}
...
object ForkApplyEventParser extends EventParser[ForkApplyEvent, ForkApplyEventPayload]("ForkApplyEvent")
{
   ...
   override def make(event: GH2011EventBody, payload: ForkApplyEventPayload): GH2013Event = ForkApplyEvent(event, payload)
}
...
object IssueCommentEventParser extends EventParser[IssueCommentEvent, IssueCommentEventPayload]("IssueCommentEvent")
{
   ...
   override def make(event: GH2011EventBody, payload: IssueCommentEventPayload): GH2013Event = IssueCommentEvent(event, payload)
}
