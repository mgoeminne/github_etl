...
import gh3.events.DeploymentEvent
import net.liftweb.json._
import org.scalatest.{FlatSpec, Matchers}

class DeploymentEventTest extends FlatSpec with Matchers
{
   "A valid deployment event" should "be correclty parsed" in {
      val json = parse(
         """
           | {
           |  "deployment": {
      ...
      DeploymentEvent(json).isDefined shouldBe true
   }
}
