...
import gh3.events.PullRequestReviewCommentEvent
import net.liftweb.json._
import org.scalatest.{FlatSpec, Matchers}

class PullRequestReviewCommentEventTest extends FlatSpec with Matchers
{
   "A valid PullRequest" must "be correctly parsed" in {
      ...
      PullRequestReviewCommentEvent(json).isDefined shouldBe true
   }
}
