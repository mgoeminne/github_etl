...
import gh3.{ReleaseEvent, MemberEvent}
import org.scalatest.{Matchers, FlatSpec}
import net.liftweb.json._

class ReleaseEventTest extends FlatSpec with Matchers
{
   "A valid release event" must "be correctly parsed" in {
      val json = parse(
         """
           | {
           |  "action": "published",
      ...
      ReleaseEvent(json).isDefined shouldBe true
   }
}
